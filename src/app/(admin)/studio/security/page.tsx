...
import FraudSecurityDashboard from "@/components/FraudSecurityDashboard";
import ThemeToggle from "@/components/ThemeToggle";
import AccessDenied from "@/components/AccessDenied";

export const metadata = {
  title: "Security & Fraud Intelligence — DCart Admin",
  description: "Real-time transaction risk monitoring, fraud detection, and security intelligence for DCart platform.",
};
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white dark:bg-zinc-950">
        <AccessDenied
          ...
          buttonText="Sign In"
          buttonHref={`/signin?callbackUrl=${encodeURIComponent("/studio/security")}`}
        />
      </div>
    );
  }
